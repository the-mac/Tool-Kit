...
MAC Guides are intended to assist in learning Mobile App Development. Each guide will have the full source, but there will be instructions available on how to build the related project(s) from scratch.
