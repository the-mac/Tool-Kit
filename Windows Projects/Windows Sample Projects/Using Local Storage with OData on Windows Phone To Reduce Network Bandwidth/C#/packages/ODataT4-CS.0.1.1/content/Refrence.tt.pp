...
if (TransformContext == null)
{
	...
	{
		Namespace="$rootnamespace$.DataServiceContext.ServiceRefrence1",
		//CTP BUG: get nuget to replace this with edmx path
		MetadataFilepath=@"$fullpath$Service References\ServiceReference1\service.edmx"
	};
...
void WriteTypeDeclration(IEdmEntityContainer container )
	{
#>
...
void WriteEntity(IEdmEntityType entityType)
{
	...
	WriteTypeDeclration(entityType);
...
void WriteTypeDeclration(IEdmEntityType entity )
	{
...
<#+	
	...
	void WriteComplexTypes()
	{
		 ...
		 foreach (IEdmSchemaElement element in ctxTypes)
        {
            ...
            WriteTypeDeclration(complexTypeDefinition);
...
<#+
	...
	void WriteTypeDeclration(IEdmComplexType ctxType)
	{
	...
	void WriteServiceOperations(IEdmEntityContainer container )
{
 var svcOps = from item in container.Elements
	...
	foreach (IEdmFunctionImport svcOp in svcOps)
    {
		...
		Microsoft.Data.OData.HttpMethod httpMethod;                   
...
#>															
		...
		{ 			
	 		return this.Execute(new global::System.Uri("<#=svcOp.Name#>",global::System.UriKind.Relative),Microsoft.Data.OData.HttpMethod.<#=GetServiceOperationHttpMethod(svcOp)#>);
		}	
<#+     
		}
		else
...
#>		public  System.Collections.Generic.IEnumerable< <#=returnType#>>  <#=svcOp.Name#>(<#=parameters#>)
		{ 
			return (System.Collections.Generic.IEnumerable< <#=returnType#>> )this.Execute< <#=returnType#>> (new global::System.Uri("<#= svcOpUri#>",global::System.UriKind.Relative),Microsoft.Data.OData.HttpMethod.<#=GetServiceOperationHttpMethod(svcOp)#>,false);
		}
<#+      
				}
...
#>		public  <#=returnType#>  <#=svcOp.Name#>(<#=parameters#>)
		{
			System.Data.Services.Client.QueryOperationResponse< <#=returnType#>> response =this.Execute< <#=returnType#> >(new global::System.Uri("<#= uriParameter#>",global::System.UriKind.Relative),Microsoft.Data.OData.HttpMethod.<#=GetServiceOperationHttpMethod(svcOp)#>,true);
...
Microsoft.Data.OData.HttpMethod GetServiceOperationHttpMethod(IEdmFunctionImport svcOp)
{
	foreach (IEdmAnnotation annotation in svcOp.ImmediateAnnotations)
    
    {
		Microsoft.Data.OData.HttpMethod httpMethod;
       if (annotation.LocalName() == "HttpMethod")
       {
			object obj = annotation.GetAnnotation(annotation.Namespace(), annotation.LocalName());
			IEdmImmediateValueAnnotation e = annotation as IEdmImmediateValueAnnotation;
            ...
            return (Microsoft.Data.OData.HttpMethod) Enum.Parse(typeof(Microsoft.Data.OData.HttpMethod),stringConstant.Value,true);
			
        }
    }				
	return Microsoft.Data.OData.HttpMethod.Get;
}
