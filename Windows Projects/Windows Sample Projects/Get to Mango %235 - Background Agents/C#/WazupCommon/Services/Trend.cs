...
namespace Wazup.Services
{
    ...
    public class Trend : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Gets or sets the last time tweets were retrieved for this trend.
        /// </summary>
        public DateTime last_tweet_fetch { get; set; }

        /// <summary>
        /// Gets or sets the value indicating whether or not the trend is pinned.
        /// </summary>
