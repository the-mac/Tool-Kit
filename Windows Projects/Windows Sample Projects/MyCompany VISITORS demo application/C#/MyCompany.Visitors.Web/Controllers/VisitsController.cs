namespace MyCompany.Visitors.Web.Controllers
{
    ...
    public class VisitsController : ApiController
    {
        ...
        public async Task<IEnumerable<Visit>> GetVisits(string filter, PictureType pictureType, int pageSize, int pageCount, DateTime? dateFilter, DateTime? toDate)
        {
            return await _visitRepository.GetVisitsAsync(filter, pictureType, pageSize, pageCount, dateFilter, toDate);
        }
        ...
        public async Task<IEnumerable<Visit>> GetVisitsFromDate(string filter, PictureType pictureType, int pageSize, int pageCount, DateTime dateFilter)
        {
            return await _visitRepository.GetVisitsFromDateAsync(filter, pictureType, pageSize, pageCount, dateFilter);
        }
