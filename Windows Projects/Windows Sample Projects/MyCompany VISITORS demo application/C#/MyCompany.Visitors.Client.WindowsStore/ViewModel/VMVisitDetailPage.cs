namespace MyCompany.Visitors.Client.WindowsStore.ViewModel
{
    ...
    using MyCompany.Visitors.Client.WindowsStore.Converters;
    using MyCompany.Visitors.Client.WindowsStore.Model;
    using MyCompany.Visitors.Client.WindowsStore.Model.Messages;
    ...
    using MyCompany.Visitors.Client.WindowsStore.ViewModel.Base;
    using System;
    ...
    public class VMVisitDetailPage : VMBase
    {
        ...
        /// Default constructor.
        /// </summary>
        public VMVisitDetailPage(INavigationService navService, IMyCompanyClient clientService,
                                 IMessageService messageService, ITilesService tilesService, ISampleDataService sampleDataService, IStorageService storageService)
        {
