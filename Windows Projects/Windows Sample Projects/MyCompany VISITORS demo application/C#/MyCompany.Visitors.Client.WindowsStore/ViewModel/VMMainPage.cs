namespace MyCompany.Visitors.Client.WindowsStore.ViewModel
{
    ...
    public class VMMainPage : VMBase
    {
        ...
        /// Default constructor.
        /// </summary>
        public VMMainPage(INavigationService navService, IMyCompanyClient clientService, IMessageService messageService, ITilesService tilesService, ISampleDataService sampleDataService)
        {
