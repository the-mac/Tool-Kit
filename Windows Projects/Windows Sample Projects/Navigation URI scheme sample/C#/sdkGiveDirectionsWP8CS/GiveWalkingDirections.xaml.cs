...
{
    public partial class GiveWalkingDirections : PhoneApplicationPage
    {
        public GiveWalkingDirections()
        {
            InitializeComponent();
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.tbShowRequestedDestination.Text = AppResources.WalkingDirectionsDisplayPrefix + ":\r\n" +
