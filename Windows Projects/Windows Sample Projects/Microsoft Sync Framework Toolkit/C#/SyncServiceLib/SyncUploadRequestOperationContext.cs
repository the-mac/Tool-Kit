...
namespace Microsoft.Synchronization.Services
{
    ...
    /// </summary>
    public class SyncUploadRequestOperationContext : SyncOperationContext
    {
        /// <summary>
        /// Represents the entities being uploaded by the client. 
        /// </summary>
        public ReadOnlyCollection<IOfflineEntity> IncomingChanges { get; internal set; }
        ...
        Dictionary<IOfflineEntity, string> _rejectedEntities;

        /// <summary>
        /// Gets the rejected entities
        /// </summary>
        internal Dictionary<IOfflineEntity, string> RejectedEntries
        {
            get { return this._rejectedEntities; }
        }
        ...
        /// </summary>
        internal SyncUploadRequestOperationContext() 
        {
            this._rejectedEntities = new Dictionary<IOfflineEntity, string>();
        }
    }
}
