...
namespace Microsoft.Synchronization.Services
{
    ...
    /// </summary>
    public class SyncConflictContext : SyncOperationContext
    {        
        /// <summary>
        /// Gets the Entity version being uploaded by the client.
        /// </summary>
        public IOfflineEntity ClientChange { get; internal set; }

        /// <summary>
        /// Gets the Entity version available on the server.
        /// </summary>
        public IOfflineEntity ServerChange { get; internal set; }

        /// <summary>
        /// Internal constructor to prevent public instantiation
        /// </summary>
        internal SyncConflictContext() { }
    }
}
