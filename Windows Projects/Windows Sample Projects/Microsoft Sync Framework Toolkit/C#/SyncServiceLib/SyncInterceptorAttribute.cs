...
namespace Microsoft.Synchronization.Services
{
    ...
    public class SyncInterceptorAttribute : Attribute
    {
        ...
        /// </summary>
        public ReadOnlyCollection<string> ScopeName { get; private set; }

        /// <summary>
        /// Gets the SyncOperations for which the interceptor applies
        /// </summary>
        public SyncOperations Operation { get; private set; }
        ...
        public Type EntityType
        {
            ...
            set
            {
                if (this is SyncRequestInterceptorAttribute &&
                    (this.Operation & SyncOperations.Download) == SyncOperations.Download)
                {
                    throw new ArgumentException("Cannot specify EntityType argument for SyncRequestInterceptorAttribute and SyncOperations.Download");
                }
