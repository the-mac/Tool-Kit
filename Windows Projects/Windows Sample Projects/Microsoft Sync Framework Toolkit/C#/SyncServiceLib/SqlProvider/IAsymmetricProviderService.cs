...
namespace Microsoft.Synchronization.Services
{
    ...
    /// </summary>
    internal interface IAsymmetricProviderService
    {
        /// <summary>
        ...
        GetChangesResponse GetChanges(byte[] serverBlob);
        ...
        ApplyChangesResponse ApplyChanges(byte[] clientKnowledgeBlob, List<IOfflineEntity> entities);
    }
}
