...
namespace Microsoft.Synchronization.Services.Batching
{
    ...
    /// </summary>
    internal interface IBatchHandler
    {
        /// <summary>
        ...
        void SaveBatches(List<Batch> batchList, BatchHeader header);
        ...
        Batch GetNextBatch(Guid batchCode, Guid nextBatchSequenceNumber);
    }
}
