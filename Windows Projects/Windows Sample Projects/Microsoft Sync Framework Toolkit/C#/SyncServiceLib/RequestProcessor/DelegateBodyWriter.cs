...
namespace Microsoft.Synchronization.Services
{
    ...
    {
        private readonly Action<XmlDictionaryWriter, SyncWriter> _writerAction;
        private readonly SyncWriter _syncWriter;

        public DelegateBodyWriter(bool isBuffered) : base(isBuffered)
        {
        }
        ...
        {
            _writerAction(writer, _syncWriter);
        }
    }
}