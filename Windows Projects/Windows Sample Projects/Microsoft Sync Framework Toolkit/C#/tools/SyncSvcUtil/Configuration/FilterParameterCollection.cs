...
{
    /// <summary>
    /// Represents a collection of FilterParameters for a SyncTable
    /// </summary>
    public class FilterParameterCollection : ConfigurationElementCollection
    {
        /// <summary>
        /// Creates a new Collection item element.
        /// </summary>
        /// <returns>FilterParameterConfigElement</returns>
        ...
        /// <summary>
        /// Returns the FilterParameterConfigElement.Name property for the specifed element
        /// </summary>
        /// <param name="element">ConfigurationElement</param>
        /// <returns>Name property</returns>
        protected override object GetElementKey(ConfigurationElement element)
        {
            return ((FilterParameterConfigElement)element).Name;
        }
        ...
        /// <returns>FilterParameterConfigElement</returns>
        public FilterParameterConfigElement GetElementAt(int index)
        {
            return (FilterParameterConfigElement)base.BaseGet(index);
        }        
    }
}
