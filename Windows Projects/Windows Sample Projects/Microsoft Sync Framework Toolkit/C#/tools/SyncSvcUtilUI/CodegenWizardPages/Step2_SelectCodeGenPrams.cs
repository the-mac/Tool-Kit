...
namespace SyncSvcUtilUI.CodegenWizardPages
{
    public partial class Step2_SelectCodeGenPrams : UserControl, IWizardPage
    {
        ...
        public void OnFocus()
        {
            ...
            {
                this.targetBox.Items.AddRange(new string[] { "Server", "IsolatedStore Client", "Generic Client" });
            }
            else
            {
                this.targetBox.Items.AddRange(new string[] { "IsolatedStore Client", "Generic Client" });
            }
        }
