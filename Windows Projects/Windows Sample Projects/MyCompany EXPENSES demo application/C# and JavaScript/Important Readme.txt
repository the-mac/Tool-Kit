...
The EXPENSES solution has a few projects which are dependencies for the other solutions, like:
MyCompany.Common.Web
MyCompany.Common.Security
You can used them in the other solutions (Vacation, Visitors, etc.) as assemblies/DLL or you could also copy and link the projects.
