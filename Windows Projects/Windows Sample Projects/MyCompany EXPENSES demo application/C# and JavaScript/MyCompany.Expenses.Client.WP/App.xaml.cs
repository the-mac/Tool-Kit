namespace MyCompany.Expenses.Client.WP
{
    ...
    public partial class App : Application
    {
        ...
        private bool loadingfromInstance;

        private bool runningInBackground;
        ...
        /// <summary>
        /// This event is launched when the app go to background or become active again.
        /// </summary>
        public event EventHandler<EventArgs<bool>> RunningInBackgroundChanged;
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            if (page != null)
            {
                var vm = page.DataContext as VMBase;
                if (vm != null)
                    vm.IsBusy = false;
            }

            MessageBox.Show(AppResources.ErrorUnexpected);

            if (e.ExceptionObject.GetType() == typeof(HttpRequestException))
            {
        ...
        {
            if (e.Uri.ToString().Contains("AuthenticationPage.xaml?expenseId") && this.loadingfromInstance)
            {
                e.Cancel = false;
                this.loadingfromInstance = false;
            }
            else if (e.Uri.ToString().Contains("AuthenticationPage.xaml") && this.loadingfromInstance)
            {
                e.Cancel = true;
                this.loadingfromInstance = false;
            }
