namespace MyCompany.Expenses.WebApiRole
{
    ...
    public class WebApiOutputCacheAttribute : ActionFilterAttribute
    {
        ...
        {
            if (!Boolean.TryParse(RoleEnvironment.GetConfigurationSettingValue("CacheEnabled"), out _cacheEnabled))
                _cacheEnabled = false;

            if (!Int32.TryParse(RoleEnvironment.GetConfigurationSettingValue("CacheTimespan"), out _timespan))
